...
import 'package:validation/app_module/needs_view/controller/needs_controller.dart';
...
class NeedsView extends StatelessWidget {
   NeedsView({Key? key}) : super(key: key);

  final contributionController = Get.put(NeedsController());
  @override
